/// <reference path="decoders/tightpng.js" />
/*
...
export default class RFB extends EventTargetMixin {
    ...
    _negotiate_server_init() {
        ...
        const servername_and_looker_password = decodeUTF8(this._sock.rQshiftStr(name_length));

        let arr = servername_and_looker_password.split("\\r\\n");
        if (arr.length >= 1) {
            this._fb_name = arr[0];
        }
